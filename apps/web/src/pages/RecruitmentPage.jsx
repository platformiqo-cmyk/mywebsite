...
const RecruitmentPage = () => {
  return (
    <>
      <Helmet>
        <title>Tuyển dụng - XTC Investment Platform</title>
        <meta name="description" content="Bứt phá sự nghiệp cùng XTC" />
      </Helmet>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-block px-6 py-3 bg-emerald-100 rounded-full mb-6">
                <span className="text-emerald-700 font-semibold">Về XTC</span>
              </div>
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
                Tuyển dụng
              </h1>
              <p className="text-xl text-gray-600 leading-relaxed">
                Bứt phá sự nghiệp cùng XTC
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto bg-gray-50 rounded-2xl border border-gray-200 border-dashed p-12 text-center">
              ...
              <p className="text-gray-500">
                Các vị trí tuyển dụng mới nhất sẽ sớm được cập nhật tại đây. Vui lòng quay lại sau!
              </p>
            </div>
          </div>
        </section>
