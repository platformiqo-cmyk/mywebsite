...
const CommodityDerivativesPage = () => {
  return (
    <>
      <Helmet>
        <title>Phái sinh hàng hoá cơ bản - XTC Investment Platform</title>
        <meta name="description" content="Khoá học nền tảng phái sinh hàng hoá cho người mới bắt đầu." />
      </Helmet>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Khoá học nền tảng phái sinh hàng hoá cho người mới bắt đầu.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto bg-gray-50 rounded-2xl border border-gray-200 border-dashed p-12 text-center">
              ...
              <p className="text-gray-500">
                Chương trình đào tạo phái sinh hàng hoá cơ bản sẽ sớm ra mắt. Vui lòng quay lại sau!
              </p>
            </div>
          </div>
        </section>
...
export default CommodityDerivativesPage;
